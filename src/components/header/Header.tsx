...
const Header: React.SFC<HeaderProps> = ({ home, title, siteUrl, logo, description }) => (
  <header
        ...
        <div className="site-nav-left">
          <ul className="nav" role="menu">
            <li className="nav-home nav-current" role="menuitem">
              <a href="https://demo.ghost.io/">Home</a>
            </li>
            <li className="nav-about" role="menuitem">
              <a href="https://demo.ghost.io/about/">About</a>
            </li>
            <li className="nav-getting-started" role="menuitem">
              <a href="https://demo.ghost.io/tag/getting-started/">
                Getting Started
              </a>
            </li>
